...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('PENDING', 'DOWNLOADING', 'COMPLETED', 'FAILED', name='mediastatus'), nullable=False),
    ...
    sa.Column('status', sa.Enum('INACTIVE', 'ACTIVE', 'DISABLED', name='userstatus'), nullable=False),
    ...
    op.create_index(op.f('ix_user_platforms_deleted_at'), 'user_platforms', ['deleted_at'], unique=False)
    op.create_index(op.f('ix_user_platforms_updated_at'), 'user_platforms', ['updated_at'], unique=False)
    ...
    op.create_index(op.f('ix_parse_results_deleted_at'), 'parse_results', ['deleted_at'], unique=False)
    op.create_index(op.f('ix_parse_results_updated_at'), 'parse_results', ['updated_at'], unique=False)
    op.create_table('user_authors',
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('author_id', sa.Integer(), nullable=False),
    sa.Column('created_at', AwareDatetime(), nullable=False),
    sa.Column('updated_at', AwareDatetime(), nullable=False),
    ...
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('type', sa.Enum('PARSE_CONTENT', 'MEDIA_DOWNLOAD', 'CONTENT_ANALYSIS', name='tasktype'), nullable=False),
    sa.Column('status', sa.Enum('PENDING', 'RUNNING', 'CANCELED', 'COMPLETED', 'FAILED', name='taskstatus'), nullable=False),
    sa.Column('role', sa.Enum('PRIMARY', 'LINKED', 'REUSED', name='taskrole'), nullable=True),
    sa.Column('url', sa.String(), nullable=False),
    ...
    op.create_table('parse_result_media',
    ...
    op.create_table('user_parse_results',
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('parse_result_id', sa.Integer(), nullable=False),
    sa.Column('created_at', AwareDatetime(), nullable=False),
    sa.Column('updated_at', AwareDatetime(), nullable=False),
    ...
    op.create_index(op.f('ix_user_parse_results_deleted_at'), 'user_parse_results', ['deleted_at'], unique=False)
    op.create_index(op.f('ix_user_parse_results_updated_at'), 'user_parse_results', ['updated_at'], unique=False)
