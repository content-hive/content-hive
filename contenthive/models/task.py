...
class MainTaskEntity:
    ...
    status: TaskStatus
    url: str
    role: TaskRole | None = field(default=None)
    parameters: dict[str, Any] = field(default_factory=dict)
    result: dict[str, Any] | None = field(default=None)
    error_message: str | None = field(default=None)
    started_at: datetime | None = field(default=None)
    completed_at: datetime | None = field(default=None)
    primary_task_id: int | None = field(default=None)
    parse_result_id: int | None = field(default=None)
...
class SubTaskEntity:
    ...
    started_at: datetime | None = field(default=None)
    completed_at: datetime | None = field(default=None)
    depends_on_id: int | None = field(default=None)
    created_at: datetime | None = field(default=None)
    updated_at: datetime | None = field(default=None)
    deleted_at: datetime | None = field(default=None)
...
class MainTaskInfo(APIBaseModel):
    ...
    parameters: MainTaskParameters | None = Field(None, description="Task parameters")
    ...
    def from_entity(cls, entity: MainTaskEntity, include_sub_tasks: bool = False) -> "MainTaskInfo":
        ...
        return cls(
            ...
            url=entity.url,
            role=entity.role,
            parameters=parse_main_task_parameters(entity.type, entity.parameters),
...
class TaskListQuery(APIBaseModel):
    ...
    role: TaskRole | None = Field(None, description="Filter by role")
